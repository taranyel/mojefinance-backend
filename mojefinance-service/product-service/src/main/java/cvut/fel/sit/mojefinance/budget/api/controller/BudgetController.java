...
import cvut.fel.sit.mojefinance.budget.api.mapper.BudgetsMapper;
import cvut.fel.sit.mojefinance.budget.domain.service.BudgetService;
...
public class BudgetController implements BudgetsApi {
    ...
    public ResponseEntity<Void> createBudget(String authorization, BudgetRequest budgetRequest) {
        cvut.fel.sit.mojefinance.budget.domain.dto.BudgetRequest budgetDomainRequest = budgetsMapper
    ...
    public ResponseEntity<BudgetsResponse> getBudgets(String authorization) {
        cvut.fel.sit.mojefinance.budget.domain.dto.BudgetsResponse domainResponse = budgetService.getBudgets();
