...
class BudgetsMapperTest {
    ...
    void toBudgetRequest_mapsFieldsCorrectly() {
        ...
        cvut.fel.sit.mojefinance.product.domain.dto.BudgetRequest result = mapper.toBudgetRequest(openApiBudgetRequest);
    ...
    void toBudgetsResponse_mapsFieldsCorrectly() {
        ...
        cvut.fel.sit.mojefinance.product.domain.entity.Budget budget = cvut.fel.sit.mojefinance.product.domain.entity.Budget.builder()
                .budgetId(2L)
                ...
                .build();
        cvut.fel.sit.mojefinance.product.domain.dto.BudgetsResponse budgetsResponse = cvut.fel.sit.mojefinance.product.domain.dto.BudgetsResponse.builder().budgets(List.of(budget)).build();
